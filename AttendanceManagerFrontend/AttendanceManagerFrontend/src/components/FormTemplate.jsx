// export default function htmlFormTemplate({user}) {
//     return(
//         <div>
...
//                 <input type="number" id="sem" name="sem" placeholder="Enter your semester" required/><br/>
//                 </>
//             )}
...
export default function FormTemplate({user}) {
  return (
    <div>
